...
export class FhevmDecryptionSignature {
  ...
  static checkIs(s: unknown): s is FhevmDecryptionSignatureType {
    ...
    if (!("domain" in s.eip712 && typeof s.eip712.domain === "object")) return false;
    if (!("primaryType" in s.eip712 && typeof s.eip712.primaryType === "string")) return false;
    if (!("message" in s.eip712)) return false;
    if (!("types" in s.eip712 && typeof s.eip712.types === "object" && s.eip712.types !== null)) return false;
    return true;
  }
